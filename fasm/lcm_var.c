...
// PAOLO
#define MAX_ITEMSET_STR_LEN 256ll
int LCM_ap;
int* LCM_patterns_with_supp;
int LCM_sign = 0;
int LCM_testable_size, LCM_i_testable = 0;
char* LCM_testable_patterns;
PV_ID_PAIR* LCM_testable_occurrences;
